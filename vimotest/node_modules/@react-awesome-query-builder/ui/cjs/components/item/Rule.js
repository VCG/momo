  ...
  return (0, _createClass2["default"])(Rule, [{
    ...
    value: function onPropsChanged(nextProps) {
      ...
      if (configChanged) {
        ...
        this.Btn = (0, _utils.getRenderFromConfig)(config, renderButton);
        this.BtnGrp = (0, _utils.getRenderFromConfig)(config, renderButtonGroup);
        this.Switch = (0, _utils.getRenderFromConfig)(config, renderSwitch);
        this.BeforeWidget = (0, _utils.getRenderFromConfig)(config, renderBeforeWidget);
        this.AfterWidget = (0, _utils.getRenderFromConfig)(config, renderAfterWidget);
    ...
    value: function renderBeforeWidget() {
      ...
      }, /*#__PURE__*/_react["default"].createElement(BeforeWidget, this.props));
    }
  }, {
    ...
    value: function renderAfterWidget() {
      ...
      }, /*#__PURE__*/_react["default"].createElement(AfterWidget, this.props));
    }
  }, {
    key: "renderError",
