...
var FuncSelect = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return (0, _createClass2["default"])(FuncSelect, [{
    ...
    value: function buildOptions(config, funcs) {
      ...
      return (0, _keys["default"])(funcs).map(function (funcKey) {
        var fullFuncPath = [].concat((0, _toConsumableArray2["default"])(path !== null && path !== void 0 ? path : []), [funcKey]);
    ...
    value: function getFuncLabel(funcOpts, funcKey, config) {
      ...
      var label = (funcOpts === null || funcOpts === void 0 ? void 0 : funcOpts.label) || (0, _last["default"])(funcParts);
