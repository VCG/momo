...
exports.getCommonMemo = exports.findExtendedConfigInAllMemos = exports.createConfigMemo = void 0;
...
var commonMemo;
var memos = {};
var getCommonMemo = exports.getCommonMemo = function getCommonMemo() {
  if (!commonMemo) {
...
var createConfigMemo = exports.createConfigMemo = function createConfigMemo() {
  ...
  var extendAndStore = function extendAndStore(config) {
    var extendedConfig = (0, _configExtend.extendConfig)(config, ++configId, meta.canCompile);
  ...
  var findBasic = function findBasic(findConfig) {
    ...
    try {
      var _loop = function _loop() {
          ...
          var found = _configUtils.configKeys.map(function (k) {
