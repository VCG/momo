...
function MotifPanel(props) {
  var processRequest = props.processRequest,
  ...
  var _useState3 = (0, _react.useState)(false),
    ...
    enableAbsMotifCountInfo = _useState4[0],
    setEnableAbsMotifCountInfo = _useState4[1];
  var _useState5 = (0, _react.useState)("neutral"),
    _useState6 = _slicedToArray(_useState5, 2),
    countButtonColor = _useState6[0],
    setCountButtonColor = _useState6[1];
  var _useState7 = (0, _react.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    cypherLoading = _useState8[0],
    setCypherLoading = _useState8[1];
  var motifPanelId = "motif-panel-div";
  var context = (0, _react.useContext)(_GlobalContext.AppContext);
  var displayMotifCount = typeof attributes.displayMotifCount != "undefined" ? attributes.displayMotifCount : false;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 3;
            _context.next = 6;
            return processRequest(context.motifQuery, number);
          case 6:
            _context.next = 12;
            break;
          case 8:
