...
function QueryBuilder(_ref) {
  ...
  })), tree && (context === null || context === void 0 ? void 0 : (_context$selectedSket2 = context.selectedSketchElement) === null || _context$selectedSket2 === void 0 ? void 0 : _context$selectedSket2.type) === "edge" && (Object.keys(EdgeFields).length > 0 ? /*#__PURE__*/_react.default.createElement(_reactAwesomeQueryBuilder.Query, _extends({}, InitialConfig, {
    fields: EdgeFields,
    value: context.selectedSketchElement.tree || tree,
    onChange: onChange,
    renderBuilder: renderBuilder
