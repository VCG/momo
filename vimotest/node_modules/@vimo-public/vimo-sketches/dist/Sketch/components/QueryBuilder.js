...
function QueryBuilder(_ref) {
  ...
  var NodeFields = _ref.NodeFields,
    EdgeFields = _ref.EdgeFields;
  ...
  (0, _react.useEffect)(function () {
    ...
    setTree(_mui.Utils.checkTree(_mui.Utils.loadTree(queryValue), _objectSpread(_objectSpread({}, InitialConfig), {}, {
      fields: NodeFields
    })));
  }, []);
  (0, _react.useEffect)(function () {
  ...
  var onChange = function onChange(immutableTree, config) {
    ...
    var query = _mui.Utils.mongodbFormat(immutableTree, config);
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, tree && (context === null || context === void 0 ? void 0 : (_context$selectedSket = context.selectedSketchElement) === null || _context$selectedSket === void 0 ? void 0 : _context$selectedSket.type) === "node" && (Object.keys(NodeFields).length > 0 ? /*#__PURE__*/_react.default.createElement(_mui.Query, _extends({}, InitialConfig, {
    fields: NodeFields,
  ...
  })), tree && (context === null || context === void 0 ? void 0 : (_context$selectedSket2 = context.selectedSketchElement) === null || _context$selectedSket2 === void 0 ? void 0 : _context$selectedSket2.type) === "edge" && (Object.keys(EdgeFields).length > 0 ? /*#__PURE__*/_react.default.createElement(_mui.Query, _extends({}, InitialConfig, {
    fields: EdgeFields,
    value: context.selectedSketchElement.tree || tree,
    onChange: onChange,
    renderBuilder: renderBuilder
